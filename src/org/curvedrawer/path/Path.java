...
public abstract class Path {
	 ...
	 *
	 * @param numberOfSteps resolution of the path (how many poses to be created when creating the
	 * path)
	 * @param points defining points that define the path
	 */
	public Path(int numberOfSteps, Point... points) {
		this.points = new SimpleListProperty<>(
			FXCollections.observableArrayList(p -> new Observable[]{p.xProperty(), p.yProperty()}));
