...
public class CirclePoint extends Circle {
	...
	/**
	 * Selects the circle if it is true and doubles the radius all the while notifying the path
	 * group that the circle has been selected otherwise resets the radius to be its default size
	 * and notifies the path group that it is no longer selected
	 *
