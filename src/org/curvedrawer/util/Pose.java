...
public class Pose {
	...
	public Pose(Number value, Number value1) {
		this(value.doubleValue(), value1.doubleValue(), 0);
	}
	...
	public final Pose offsetPerpendicular(double distance) {
		...
		double offsetX = distance * StrictMath
			.cos(angleOfDT + (Math.PI / 2.0)); // Finds point at distance along perpendicular
		// line
