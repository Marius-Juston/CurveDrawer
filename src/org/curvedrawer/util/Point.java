...
/**
 * This class is meant to be utilized to define a key points that define a path such as knots for
 * splines and control points for bezier curves. This has an x,y and a name
 */
public class Point {
	 ...
	 * Initializes the instance variables
	 *
	 * @param point2D point2D to pass in. It will use the x and y coordinates of the point 2D as its
	 * own.
	 */
